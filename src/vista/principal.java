...
public class principal extends javax.swing.JFrame {
    ...
    DefaultTableModel TablaParticipantes = new DefaultTableModel();
    String usuario;
    String pwd;
    Connection con;
    ...
    public principal() {
        ...
        TablaParticipantes   = (DefaultTableModel) jTablaParticipantes1.getModel();
        ...
        participantes.setSize(new Dimension(869,484));
        participantes.setLocationRelativeTo(null); 
        
        participantesGNRAL.setSize(new Dimension(989,484));
        participantesGNRAL.setLocationRelativeTo(null);
    ...
    public void InsertarReprensentanteGRUPO(String Usuario){
        ...
        if (txtNR1.getText().isEmpty() || txtTel.getText().isEmpty() || txtClav.getText().isEmpty() || txtSeccio.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Hace falta datos.");
        ...
        try (PreparedStatement insercionPreparada = conexion.prepareStatement(sql)) {
            ...
            limpiarReprensentanteGRUPAL();
            limpiaTabla(TablaGRUPO);
    ...
    public void consultarParticipantes(DefaultTableModel x) { //Metodo que ayuda a realizar la consulta del producto
        Object[] ob = new Object[15];//Se define un arreglo de objetos
        try {
            rs = ejecutaQuery("select * from participantes");//Se reaalizar una consulta de producto
            while (rs.next()) { //Se le asignan los valor a un arreglo de objetos 
                ob[0] = rs.getObject("id_participantes");
                ob[1] = rs.getObject("participante"); 
                ob[2] = rs.getObject("clave_elector");
                ob[3] = rs.getObject("seccion_electoral");
                ob[4] = rs.getObject("edad");
                ob[5] = rs.getObject("telefono");
                ob[6] = rs.getObject("sexo");
                ob[7] = rs.getObject("domicilio");
                ob[8] = rs.getObject("localidad");
                ob[9] = rs.getObject("current_ee");
                ob[10] = rs.getObject("observarciones");
                ob[11] = rs.getObject("representante_gpo");
                ob[12] = rs.getObject("nomenclatura");
                ob[13] = rs.getObject("id_representante_gpo");
                ob[14] = rs.getObject("id_lista");
                x.addRow(ob);//Se agrega los campos en un JTable
            }
            conexion.close();//Se cierra conexion
        } catch (Exception e) {
      ...
      public void eliminarRegistroReprensentanteGRUPO(DefaultTableModel dtm) { //Metodo que ayuda a elimanr productos
        try {
            if (jTablaGrupo.getSelectedRow() < 0) { //Se verifica si el usuario eligio alguna fila para moficar          
                JOptionPane.showMessageDialog(null, "Selecione algun registro para eliminar");//Mensaje para notificar que tiene que seleccionar un prodcuto
            } else {
                int fila = jTablaGrupo.getSelectedRow(); //Se asigna la fila seleccionada
                int id = Integer.parseInt(jTablaGrupo.getValueAt(fila, 0).toString());
               rs = ejecutaQuery("delete from  representantes_gpo where id_representante_gpo=" + id + ";");
                    JOptionPane.showMessageDialog(null, "Registro eliminado");
                    conexion.close();
                    dtm.removeRow(jTablaGrupo.getSelectedRow());
    ...
    if (fila >= 0) { // Verificar si se ha seleccionado una fila
      ...
      public void CambiarDatosRepresentanteGRUPO() {
    int fila = jTablaGrupo.getSelectedRow();
    
    if (fila >= 0) { // Verificar si se ha seleccionado una fila
        int id = Integer.parseInt( jTablaGrupo.getValueAt(fila, 0).toString());
                 PreparedStatement ps;
        try {
            String actualizacion = "UPDATE representantes_gpo SET representante_gpo= ?, telefono= ?, clave_elector= ?, seccion_electoral= ? where id_representante_gpo=" + id + ";";
            System.out.println(actualizacion);
            // Usando try-with-resources para manejar el cierre automático de recursos
            
            ps = con.prepareStatement(actualizacion);
                ps.setString(1, txtNR1.getText());
                ps.setString(2, txtTel.getText());
                ps.setString(3, txtClav.getText());
                ps.setString(4, txtSeccio.getText());
    ...
    private void initComponents() {
        ...
        participantesGNRAL = new javax.swing.JDialog();
        jPanel8 = new javax.swing.JPanel();
        jScrollPane4 = new javax.swing.JScrollPane();
        jTablaParticipantes1 = new javax.swing.JTable();
        ...
        jScrollPane2.setViewportView(jTablaParticipantes);
        ...
        participantesGNRAL.setUndecorated(true);

        jTablaParticipantes1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Nombre", "Clave", "Seccion", "Edad", "Telefono", "Sexo", "Domicilio", "Localidad", "EE", "Observaciones", "Representante", "Nomenclatura"
            }
        ));
        jScrollPane4.setViewportView(jTablaParticipantes1);
        ...
        jMenuItem15.setText("Regresar al inicio");
        ...
        participantesGNRAL.setJMenuBar(jMenuBar6);

        javax.swing.GroupLayout participantesGNRALLayout = new javax.swing.GroupLayout(participantesGNRAL.getContentPane());
        participantesGNRAL.getContentPane().setLayout(participantesGNRALLayout);
        participantesGNRALLayout.setHorizontalGroup(
            participantesGNRALLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(participantesGNRALLayout.createSequentialGroup()
                .addComponent(jPanel8, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        participantesGNRALLayout.setVerticalGroup(
            participantesGNRALLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jMenuItem14.setText("Participante");
  ...
  private void btnModificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificar1ActionPerformed
          if (jTablaGrupo.getSelectedRow() < 0) { //Se verifica si el usuario eligio alguna fila para moficar          
            JOptionPane.showMessageDialog(null, "Selecione el dato a editar");//En caso de no haber seleccionada alguna se le manda este mensage
        } else if (txtNR1.getText().isEmpty() ||txtTel.getText().isEmpty() ||txtClav.getText().isEmpty() ||txtSeccio.getText().isEmpty()){
          JOptionPane.showMessageDialog(null, "Ingrese los datos solicitados", "Error", JOptionPane.ERROR_MESSAGE);
        }else{

            
           CambiarDatosRepresentanteGRUPO();
           limpiaTabla(TablaGRUPO);
           limpiarReprensentanteGRUPAL();
           consultarReprensentanteGRUPAL(TablaGRUPO);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        eliminarRegistroReprensentanteGRUPO(TablaGRUPO);
       limpiaTabla(TablaGRUPO);
       limpiarReprensentanteGRUPAL();
       consultarReprensentanteGRUPAL(TablaGRUPO);
    ...
    private void jMenuItem14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem14ActionPerformed
         participantesGNRAL.dispose();
         participantesGNRAL.setVisible(true);
         this.setVisible(false);
         limpiaTabla(TablaGENERAL);
         consultarParticipantes(TablaParticipantes);
    ...
    private void jMenuItem15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem15ActionPerformed
        // TODO add your handling code here:
         participantesGNRAL.setVisible(false);
         this.setVisible(true);
    ...
    private javax.swing.JTable jTablaParticipantes1;
    ...
    private javax.swing.JDialog participantesGNRAL;
